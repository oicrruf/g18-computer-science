  ...
  for (let i in arreglo) {
    ...
    let card = `<article class="media has-background-white p-3">
            ...
            <div class="content">
              ...
              <button id="${i}" class="button is-block is-small is-pulled-right" data-type="favorites">💛</button>
              </div>
              </div>
              </div>
              </div>
              </article>`;
              // <button id="${i}" class="button is-block  is-success is-small" >Eliminar</button>
